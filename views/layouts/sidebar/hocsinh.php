<nav class="sidebar">
    <div class="sidebar-content">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?controller=ketquahoctap&action=index">
            ...
            <li class="nav-item">
                <a href="index.php?controller=thongbao&action=danhsach" class="nav-link">
                    ...
                    <span>
                        Thông báo
                        <?php 
                        // Sử dụng toán tử ?? để tránh lỗi undefined variable
                        $count = $soThongBaoChuaDoc ?? 0; 
                        if ($count > 0): 
                        ?>
                        <span class="badge bg-danger float-right"><?php echo $count; ?></span>
                        <?php endif; ?>
                    </span>
                </a>
            </li>
            ...
            <?php 
            // Kiểm tra nếu là học sinh và có thông tin khối là 11
            if (isset($_SESSION['user']) && 
                ($_SESSION['user']['vaiTro'] ?? '') == 'HOCSINH' && 
                ($_SESSION['user']['khoi'] ?? 0) == 11): 
            ?>
            <li class="nav-item">
